...
public class FFT {
    ...
    public void rftfsub(double[] a, int nc, double[] c, int nw)
    {
        int j, k, kk, ks, m;
    ...
    public void rftbsub(double[] a, int nc, double[] c, int nw)
    {
        int j, k, kk, ks, m;
        double wkr, wki, xr, xi, yr, yi;
    ...
    public void cftmdl(int l, double[] a)
    {
